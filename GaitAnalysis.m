...
imageNames = dir(fullfile('test_data','diff_mf_threshold2','*.jpg'));
imageNames = {imageNames.name}';

outputVideo = VideoWriter(fullfile('test_data/output','diff_mf_threshold2.avi'));
...
for i = 1:1200
   ...
   img = imread(fullfile('test_data','diff_mf_threshold2',imageIndexName));

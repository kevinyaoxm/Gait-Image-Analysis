...
=======
%count = i-1;
>>>>>>> 1f2a5c04ec51bbde0e760840b58d84337504ec59
for i=1:count
...
imageNames = dir(fullfile('test_data','diff_threshold_without_noise','*.jpg'));
imageNames = {imageNames.name}';

outputVideo = VideoWriter(fullfile('test_data/output','diff_threshold_without_noise.avi'));
...
for i = 1:1207
   ...
   img = imread(fullfile('test_data','diff_threshold_without_noise',imageIndexName));
